  ...
  return (
    <div className="space-y-6">
      ...
      <section className="qazera-panel p-6">
        <p className="text-base font-semibold text-foreground">New group</p>
        <form
        ...
        >
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <label className="block">
              <span className="mb-2 block text-xs font-medium text-muted-foreground">Domain</span>
              <select
                value={domainId}
          ...
          <div>
            <span className="mb-2 block text-xs font-medium text-muted-foreground">Members</span>
              ...
              {groups.data.groups.map((g) => (
                <tr key={g.id}>
                  <td className="px-4 py-3 font-semibold">
                    {g.address}
                    {g.name && <span className="ml-2 font-mono text-xs text-muted-foreground">{g.name}</span>}
                  </td>
                  <td className="px-4 py-3 text-muted-foreground">{g.members.join(", ")}</td>
                  <td className="px-4 py-3 font-mono text-xs text-muted-foreground">{g.policy}</td>
